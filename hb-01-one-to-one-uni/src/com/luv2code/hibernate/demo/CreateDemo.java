...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Instructor tempInstructor = new Instructor("Berbin", "GJ", "berby@gmail.com");
			
			InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.berby.com/youtube", "photo");
